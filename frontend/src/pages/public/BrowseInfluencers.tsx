...
import { SlidersHorizontal, Grid3X3, List, Users } from 'lucide-react';
...
export function BrowseInfluencers() {
  ...
  return (
    <div className="max-w-page section-padding py-8 sm:py-12">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900">
          Explore <span className="gradient-text">Influencers</span>
        </h1>
              ...
              <div className="space-y-1">
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm rounded-lg ${
                    !categoryParam ? 'bg-neutral-100 font-medium' : 'text-neutral-600'
                  }`}
                >
                  All Categories
                </button>
                {categories.map((cat) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-2.5 text-sm rounded-lg ${
                      categoryParam === cat.slug ? 'bg-neutral-100 font-medium' : 'text-neutral-600'
                    }`}
                  >
                    {cat.name}
                  </button>
